...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#feeaf0] py-12 px-6 relative">
      ...
      {activeSection && (
        <div
          className="fixed inset-0 z-50 bg-black/50 backdrop-blur-md overflow-y-auto"
        ...
        >
          ...
          >
            <div className="bg-white rounded-[36px] max-w-3xl w-full p-10 relative">
              {/* CLOSE */}
              <button
                onClick={() => setActiveSection(null)}
              ...
              {/* IMAGE */}
              <div className="relative w-full h-[420px] rounded-[28px] overflow-hidden mb-10 bg-gray-200">
                <img
